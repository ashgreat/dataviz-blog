...
Using `economics` dataset from `ggplot2`, recreate the following line graph. Learn more about the variables in the dataset by typing `?economics` in the console. Here, the Y acis is plotting unemployment. 
